...
void my_with_defined_object_parameters_function2(Php::Parameters &params)
{
    for (unsigned int i = 0; i < params.size(); i++)
    {
        cout << params[i] << endl;
...
extern "C" 
{
    ...
    PHPCPP_EXPORT void *get_module()
    {
        ...
        extension.add<my_with_defined_object_parameters_function>("my_with_defined_object_parameters_function", {
            Php::ByVal("myClassObjVar", "PhpCpp\\Examples\\MyPhpClass")
            });
        
        Php::Namespace myNamespace("Vendor");

        // NamespacedObject Methods ========================
        Php::Class<NamespacedObject> NamespacedObject("NamespacedObject", 0);        
        NamespacedObject.method<&NamespacedObject::__construct>("__construct", Php::Public, {
            Php::ByVal("x", Php::Type::Numeric),
            Php::ByVal("y", Php::Type::Numeric)
        });
        NamespacedObject.method<&NamespacedObject::getX>("getX", Php::Public);
        NamespacedObject.method<&NamespacedObject::getY>("getY", Php::Public);
        NamespacedObject.method<&NamespacedObject::getString>("__toString", Php::Public);
        // extension.add<my_with_defined_object_parameters_function2>("my_with_defined_object_parameters_function", {
        //     Php::ByVal("myClassObjVar", "Vendor\\NamespacedObject")
        //     });

        myNamespace.add(std::move(NamespacedObject));
